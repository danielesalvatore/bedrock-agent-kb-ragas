...
class AossStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, dict1, agent_arn, **kwargs) -> None:
        ...
        opensearch_serverless_encryption_policy = opensearchserverless.CfnSecurityPolicy(
            self,
        ...
        opensearch_serverless_network_policy = opensearchserverless.CfnSecurityPolicy(
            self,
        ...
        bedrock_kb_role = iam.Role(
            ...
            'bedrock-kb-role',
            role_name=(
                "bedrock-kb-role-" + str(hashlib.sha384(hash_base_string).hexdigest())[:15]
            ).lower(),
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            ...
            [
                NagPackSuppression(
                    ...
                    reason="Premissive permissions required as per aoss documentation.",
                ),
                NagPackSuppression(
        ...
        CfnOutput(
            self, "BedrockKbRoleArn", value=bedrock_kb_role_arn, export_name="BedrockKbRoleArn"
        )
        ...
        opensearch_serverless_access_policy = opensearchserverless.CfnAccessPolicy(
            self,
