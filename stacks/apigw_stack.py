...
class ApiGwStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, dict1, **kwargs) -> None:
        ...
        hash_base_str = self.account + self.region
        hash_base_string = hash_base_str.encode("utf8")
        ...
        agent_invocation_lambda = _lambda.Function(
            ...
            current_version_options=_lambda.VersionOptions(
                removal_policy=RemovalPolicy.RETAIN, provisioned_concurrent_executions=2
            ),
        )
        ...
        agent_invocation_lambda.role.add_to_principal_policy(
            iam.PolicyStatement(
        ...
        CfnOutput(
            self,
            "LambdaAgentInvocationHandlerArn",
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            ...
            [
                ...
                NagPackSuppression(
                    ...
                    reason="The agent does need to invoke changing agents aliases and the wildcard is needed to avoid unreasonable toil.",
                ),
            ],
            True,
        )
        ...
        apigw_access_loggroup = logs.LogGroup(
            self,
            "apigw-log-group",
            log_group_name=(
                "apigw-access-log-group-" + str(hashlib.sha384(hash_base_string).hexdigest())[:15]
            ).lower(),
        ...
        request_model = agent_apigw_endpoint.add_model(
            "BrRequestValidatorModel",
            ...
            schema=apigw.JsonSchema(
                ...
                properties={
                    "sessionId": apigw.JsonSchema(
                        type=apigw.JsonSchemaType.STRING, min_length=2, max_length=32
                    ),
                    "userPrompt": apigw.JsonSchema(
                        type=apigw.JsonSchemaType.STRING, min_length=1, max_length=500
                    ),
                },
            ),
        )
        ...
        cfn_documentation_part = apigw.CfnDocumentationPart(
            self,
            "MyCfnDocumentationPart",
            location=apigw.CfnDocumentationPart.LocationProperty(type="API"),
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            ...
            [
                NagPackSuppression(
                    ...
                    reason="The service role permission for cloudwatch logs are handled by the LambdaRestApi Construct.",
                )
            ],
            True,
        )
        ...
        NagSuppressions.add_resource_suppressions(
            ...
            [
                NagPackSuppression(
                    id="AwsSolutions-APIG2", reason="Request validation is in fact enabled."
                ),
                NagPackSuppression(
                    id="AwsSolutions-APIG4", reason="We do not need an authorizer at this point."
                ),
                NagPackSuppression(
                    id="AwsSolutions-COG4",
                    reason="We may or not use a Cognito user pool authorizer.",
                ),
            ],
            True,
        )
        ...
        #         "vpc-flowlog-group",
        #         log_group_name=(
        #             "vpc-flowlog-group-" + str(hashlib.sha384(hash_base_string).hexdigest())[:15]
        #         ).lower(),
        #         log_group_class=logs.LogGroupClass.STANDARD,
        #         retention=logs.RetentionDays.ONE_MONTH,
        #         removal_policy=RemovalPolicy.DESTROY,
        ...
        #                 self, "certificate", certificate_arn=acm_certificate_arn
        #             )
        ...
        #         load_balancer_name=(
        #             "saas-companion-" + str(hashlib.sha384(hash_base_string).hexdigest())[:15]
        #         ).lower(),
        ...
        #             NagPackSuppression(
        #                 id="AwsSolutions-IAM5",
        #                 reason="Role is controlled to services, and actions where limited service API calls required. Where wildcards are used, these are prefixed with resources partial or complete ARNs.",
        #             )
        #         ],
        #         True,
        #     )
        ...
        #             NagPackSuppression(
        #                 id="AwsSolutions-IAM5",
        #                 reason="Role is default via the generating construct.",
        #             )
        #         ],
        #         True,
        #     )
        ...
        #                 reason="Load Balancer not mission criticial, access logs not needed for POC.",
        #             ),
        #             NagPackSuppression(
        #                 id="AwsSolutions-EC23",
        #                 reason="Expected public access for this POC. Is reinforced by Cognito.",
        #             ),
        #         ],
        #         True,
        #     )
        ...
        #                 reason="Data is non-sensitive. As this is a POC environment variables are OK.",
        #             )
        #         ],
        #         True,
        #     )
        ...
        #                 reason="Container insights is not required for POC environment.",
        #             )
        #         ],
        #         True,
        #     )
        ...
        #             ecs.MountPoint(
        #                 container_path="/usr/src", source_volume="my-efs-volume", read_only=False
        #             )
        #         )
        ...
        #             else load_balanced_service.load_balancer.load_balancer_dns_name
        #         )
        ...
        #             [
        #                 NagPackSuppression(
        #                     id="AwsSolutions-COG2", reason="MFA is not required for the prototype."
        #                 )
        #             ],
        #             True,
        #         )
        ...
        #                 domain_prefix="saas-acs-genai-"
        #                 + str(hashlib.sha384(hash_base_string).hexdigest())[:15]
        #             ),
        #         )
        ...
        #             "NetworkAssistantUserPoolClient",
        #             o_auth=cognito.OAuthSettings(
        #                 scopes=[cognito.OAuthScope.OPENID],
        #                 callback_urls=[full_domain_name + "/oauth2/idpresponse"],
