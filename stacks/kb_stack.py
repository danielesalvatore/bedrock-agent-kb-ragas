...
class KnowledgeBaseStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, dict1, agent_arn, **kwargs) -> None:
        ...
        CfnOutput(
            self, "BedrockKbName", value=bedrock_knowledge_base.name, export_name="BedrockKbName"
        )
        ...
        kb_data_source = bedrock.CfnDataSource(
            ...
            data_source_configuration=bedrock.CfnDataSource.DataSourceConfigurationProperty(
                s3_configuration=bedrock.CfnDataSource.S3DataSourceConfigurationProperty(
                    ...
                    inclusion_prefixes=["fao-basic-texts"],
                ),
                type="S3",
            ),
        ...
        agent_kb_association_cr = cr.AwsCustomResource(
            self,
        ...
        # Define IAM permission policy for the custom resource
        agent_kb_association_cr.grant_principal.add_to_principal_policy(
            iam.PolicyStatement(
                effect=iam.Effect.ALLOW,
                actions=[
        ...
        NagSuppressions.add_resource_suppressions(
            ...
            [
                NagPackSuppression(
                    ...
                    reason="We support the use of wildcards. But a backlog item should be added to restrict the resources to the specific resources that the custom resource needs to access",
                )
            ],
            True,
        )
        ...
        prepare_agent_cr = cr.AwsCustomResource(
            self,
            "PrepareAgent",
            on_create=cr.AwsSdkCall(
                service="bedrock-agent",
        ...
        # Define IAM permission policy for the custom resource
        prepare_agent_cr.grant_principal.add_to_principal_policy(
            iam.PolicyStatement(
                effect=iam.Effect.ALLOW,
                actions=[
